...
def visualizeResults(imgPath, roiLabels, roiScores, roiRelCoords, classes,
                     ...
                     decisionThreshold=0.0):  # read and resize image
...
def drawText(img, pt, text, textWidth=None, color=(255, 255, 255), colorBackground=None,
...
def pilDrawText(pilImg, pt, text, textWidth=None, color=(255, 255, 255), colorBackground=None,
                font=ImageFont.truetype("DejaVuSans.ttf", 16)):
    textY = pt[1]
